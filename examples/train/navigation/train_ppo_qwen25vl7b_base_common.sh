...
EXPERIMENT_NAME="navigation_ppo_qwen25vl7b_base_common"

BASEDIR=$(pwd)
SCRIPTDIR=$(dirname "$0")
EXPERIMENT_DIR=${BASEDIR}/exps/${PROJECT_NAME}/${EXPERIMENT_NAME}
SAVE_CHECKPOINT_DIR=${EXPERIMENT_DIR}/verl_checkpoints
DATASET_TRAIN=${SCRIPTDIR}/train_navigation_base_common.yaml
DATASET_VAL=${SCRIPTDIR}/val_navigation_base_common.yaml
